...
class ChatRedisPublisherTest {
    ...
    @Test
    void publish_sendsMessageToRoomChannel() {
        ChatRedisPublisher publisher = new ChatRedisPublisher(redisTemplate);
        ...
        verify(redisTemplate).convertAndSend("chat-room:100", message);
    }
}
