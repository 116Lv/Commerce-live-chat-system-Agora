...
class CouponIssueTransactionExecutorTest {
    ...
    void issue_throwsConflictWhenSoldOut() {
        CouponIssueTransactionExecutor executor = new CouponIssueTransactionExecutor(
            couponEventRepository, couponRepository, couponIssueRepository, userRepository
        );
        ...
        assertThatThrownBy(() -> executor.issue(1L, 1L))
